...
int main(int argc, char **argv) {
    ...
    double collision_avoidance = false;
    ...
    while (ros::ok()){
        ...
        while(ac.getState() != actionlib::SimpleClientGoalState::SUCCEEDED || has_moved_closer || !collision_avoidance) {//check collision avoidance also
